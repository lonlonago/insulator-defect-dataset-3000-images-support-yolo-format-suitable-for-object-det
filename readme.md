# Insulator Defect Dataset 3000 images support YOLO format suitable for object detection

# Body

Insulator Defect Dataset, 3000 images, support YOLO format, suitable for target detection, algorithm training, research use
can
